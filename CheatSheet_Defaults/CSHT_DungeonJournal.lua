...
CSHT_DJ.SHEETS = {
			...
			-- Black Rook Hold
				...
				-- Eye of Azshara
						{	TITLE = "Warlord Parjesh: Tank",
							ZONE = "Eye of Azshara",
							SUBZONE = "Hatecoil Encampment",
							ROLE = "TANK",
							NOTE = {"Position yourself behind naga reinforcements when [Impaling Spear] is being thrown to avoid being pinned.",
							"Gain threat on Hatecoil Shellbreakers when [Call Reinforcements] is cast."}
						},
						{	TITLE = "Warlord Parjesh: Healer",
							ZONE = "Eye of Azshara",
							SUBZONE = "Hatecoil Encampment",
							ROLE = "HEALER",
							NOTE = {"Position yourself behind naga reinforcements when [Impaling Spear] is being thrown to avoid being pinned.",
						...
						{	TITLE = "Warlord Parjesh: Damage Dealers",
							ZONE = "Eye of Azshara",
							SUBZONE = "Hatecoil Encampment",
							ROLE = "DAMAGER",
							NOTE = {"Position yourself behind naga reinforcements when [Impaling Spear] is being thrown to avoid being pinned.",
						...
						{	TITLE = "Lady Hatecoil: Tank",
							ZONE = "Eye of Azshara",
							SUBZONE = "Whispering Willows",
							ROLE = "TANK",
							NOTE = {"Move on top of a sand dune to avoid damage from [Static Nova].",
						...
						{	TITLE = "Lady Hatecoil: Damage Dealers",
							ZONE = "Eye of Azshara",
							SUBZONE = "Whispering Willows",
							ROLE = "DAMAGER",
							NOTE = {"Move on top of a sand dune to avoid damage from [Static Nova].",
						...
						{	TITLE = "Serpentrix: Tank",
							ZONE = "Eye of Azshara",
							SUBZONE = "Shipwreck Shoals",
							ROLE = "TANK",
							NOTE = {"Avoid damage from [Poison Spit] by staying downwind of Serpentrix during [Violent Winds].",
							"When Serpentrix uses [Submerge] at 33% and 66% health, interrupt it to prevent damage from [Rampage]."}
						},
						{	TITLE = "Serpentrix: Healer",
							ZONE = "Eye of Azshara",
							SUBZONE = "Shipwreck Shoals",
							ROLE = "HEALER",
							NOTE = {"Avoid damage from [Poison Spit] by staying downwind of Serpentrix during [Violent Winds].",
						...
						{	TITLE = "Serpentrix: Damage Dealers",
							ZONE = "Eye of Azshara",
							SUBZONE = "Shipwreck Shoals",
							ROLE = "DAMAGER",
							NOTE = {"When Serpentrix uses [Toxic Wound], keep moving to avoid taking damage from the [Toxic Puddle].",
							"Avoid damage from [Poison Spit] by staying downwind of Serpentrix during [Violent Winds].",
							"When Serpentrix uses [Submerge] at 33% and 66% health, interrupt it to prevent damage from [Rampage]."}
						},
						{	TITLE = "King Deepbeard: Tank",
							ZONE = "Eye of Azshara",
							SUBZONE = "Deepbeard's Cove",
							ROLE = "TANK",
							NOTE = {"Avoid damage when King Deepbeard casts [Call the Seas].",
							"Move to avoid damage from [Aftershock] after King Deepbeard casts [Quake].",
							"When King Deepbeard casts [Ground Slam] move to avoid damage!"}
						},
						{	TITLE = "King Deepbeard: Healer",
							ZONE = "Eye of Azshara",
							SUBZONE = "Deepbeard's Cove",
							ROLE = "HEALER",
							NOTE = {"Avoid damage when King Deepbeard casts [Call the Seas].",
						...
						{	TITLE = "King Deepbeard: Damage Dealers",
							ZONE = "Eye of Azshara",
							SUBZONE = "Deepbeard's Cove",
							ROLE = "DAMAGER",
							NOTE = {"Avoid damage when King Deepbeard casts [Call the Seas].",
						...
						{	TITLE = "Wrath of Azshara: Tank",
							ZONE = "Eye of Azshara",
							-- SUBZONE = "Deepbeard's Cove",
							ROLE = "TANK",
							NOTE = {"Remain within melee range of the Wrath of Aszara to prevent it using [Raging Storms].",
						...
						{	TITLE = "Wrath of Azshara: Healer",
							ZONE = "Eye of Azshara",
							-- SUBZONE = "Deepbeard's Cove",
							ROLE = "HEALER",
							NOTE = {"Avoid being sucked into the air by moving away from [Mystic Tornado] when it spawns.",
							"Dispel [Arcane Bomb] from players so they can avoid its detonation."}
						},
						{	TITLE = "Wrath of Azshara: Damage Dealers",
							ZONE = "Eye of Azshara",
							-- SUBZONE = "Deepbeard's Cove",
							ROLE = "DAMAGER",
							NOTE = {"Avoid being sucked into the air by moving away from [Mystic Tornado] when it spawns.",
